...
public class SaleAd {
    ...
    private Double price; // Cambiado a Double para ser consistente con Property
    private String city;
    ...
    public SaleAd(Long adId, String description, Double price, String city, String propertyType,
